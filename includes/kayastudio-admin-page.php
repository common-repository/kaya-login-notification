		...
		<div class="ks-wp-dashboard-page-container">
			<div class="ks-wp-dashboard-page-row">
				...
				<div class="ks-wp-dashboard-page-content">
					...
					<div class="ks-wp-dashboard-page-content-card">
						<h6 class="ks-wp-dashboard-page-content-card-title"><?php echo esc_html__('WordPress plugins by Kaya Studio', WPKLN_TEXT_DOMAIN); ?></h6>
						<p>
							<?php echo esc_html__('Kaya Studio is managed by a freelance web developer. These plugins are developed in his free time and for the love of making useful open source softwares.', WPKLN_TEXT_DOMAIN); ?>
						</p>
						<p>
							<?php echo esc_html__('Discover all the WordPress plugins developed by Kaya Studio.', WPKLN_TEXT_DOMAIN); ?>
						</p>
						<p>
							<a href="<?php echo esc_url('https://profiles.wordpress.org/kayastudio#content-plugins'); ?>" class="ks-wp-dashboard-page-btn ks-wp-dashboard-page-btn-primary" target="_blank" rel="noopener noreferrer" title="<?php echo esc_attr__('All plugins by Kaya Studio', WPKLN_TEXT_DOMAIN); ?>"><?php echo esc_html__('All plugins', WPKLN_TEXT_DOMAIN); ?></a>
						</p>
					</div>
